    ...
    rules: [
      {
        ...
        existingAccountVariable: 'existing-account',
        annualIncomeOperator: '!=null',
        annualIncomeVariable: 'annual-income',
        children: [
          { id: 'r-1-c1', selected: false, ruleName: 'Premium account holder', dataAttribute: 'Asset', operator: '>=', amount: 50000, outcome: 'Approve', existingAccountOperator: 'contains', existingAccountVariable: 'existing-account', annualIncomeOperator: '!=null', annualIncomeVariable: 'annual-income', logicOperator: 'AND' },
          { id: 'r-1-c2', selected: false, ruleName: 'Credit score 780+', dataAttribute: 'Income', operator: '>=', amount: 780, outcome: 'Approve', existingAccountOperator: '!=null', existingAccountVariable: 'existing-account', annualIncomeOperator: '!=null', annualIncomeVariable: 'credit-score', logicOperator: 'AND' },
        ],
      },
      { id: 'r-2', selected: false, ruleName: 'Low Income Denial', dataAttribute: 'Income', operator: '<', amount: 20000, outcome: 'Deny', existingAccountOperator: '!=null', existingAccountVariable: 'existing-account', annualIncomeOperator: '!=null', annualIncomeVariable: 'annual-income' },
      {
        id: 'r-3',
        selected: false,
        ...
        annualIncomeVariable: 'annual-income',
        children: [
          { id: 'r-3-c1', selected: false, ruleName: 'No existing account', dataAttribute: 'Liability', operator: '=', amount: 0, outcome: 'Deny', existingAccountOperator: '!=', existingAccountVariable: 'existing-account', annualIncomeOperator: '!=null', annualIncomeVariable: 'annual-income', logicOperator: 'OR' },
          { id: 'r-3-c2', selected: false, ruleName: 'Recent inquiries 5+', dataAttribute: 'Liability', operator: '>=', amount: 5, outcome: 'Deny', existingAccountOperator: '!=null', existingAccountVariable: 'existing-account', annualIncomeOperator: '!=null', annualIncomeVariable: 'recent-inquiries', logicOperator: 'OR' },
        ],
      },
      { id: 'r-4', selected: false, ruleName: 'Moderate Income Approval', dataAttribute: 'Income', operator: '>=', amount: 40000, outcome: 'Approve', existingAccountOperator: '!=null', existingAccountVariable: 'existing-account', annualIncomeOperator: '!=null', annualIncomeVariable: 'annual-income' },
      { id: 'r-5', selected: false, ruleName: 'Low Expense Approval', dataAttribute: 'Expense', operator: '<=', amount: 15000, outcome: 'Approve', existingAccountOperator: '!=null', existingAccountVariable: 'existing-account', annualIncomeOperator: '!=null', annualIncomeVariable: 'annual-income' },
    ],
  },
  {
    id: 'rs-2',
    ...
    rules: [
      { id: 'r-6', selected: false, ruleName: 'Premium Income Rule', dataAttribute: 'Income', operator: '>', amount: 100000, outcome: 'Approve', existingAccountOperator: '!=null', existingAccountVariable: 'existing-account', annualIncomeOperator: '!=null', annualIncomeVariable: 'annual-income' },
      { id: 'r-7', selected: false, ruleName: 'Expense Threshold', dataAttribute: 'Expense', operator: '=', amount: 30000, outcome: 'Deny', existingAccountOperator: '!=null', existingAccountVariable: 'existing-account', annualIncomeOperator: '!=null', annualIncomeVariable: 'annual-income' },
    ],
  },
  {
    id: 'rs-3',
    name: 'Override Rules',
    rules: [
      { id: 'r-8', selected: false, ruleName: 'Manual Override Approval', dataAttribute: 'Income', operator: '>=', amount: 0, outcome: 'Approve', existingAccountOperator: '!=null', existingAccountVariable: 'existing-account', annualIncomeOperator: '!=null', annualIncomeVariable: 'annual-income' },
    ],
  },
]
