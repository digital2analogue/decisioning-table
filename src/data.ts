  ...
  rules: [
    {
      ...
      children: [
        ...
        { id: 'r-1-c2', selected: false, ruleName: 'Credit score 780+', dataAttribute: 'Income', operator: '>=', amount: 780, outcome: 'Approve', existingAccountOperator: null, existingAccountVariable: 'checking', annualIncomeOperator: '>=', annualIncomeVariable: '85000', logicOperator: 'AND' },
      ],
    },
    { id: 'r-2', selected: false, ruleName: 'Low Income Denial', dataAttribute: 'Income', operator: '<', amount: 20000, outcome: 'Deny', existingAccountOperator: null, existingAccountVariable: 'checking', annualIncomeOperator: '<', annualIncomeVariable: '30000' },
    {
      ...
      children: [
        { id: 'r-3-c1', selected: false, ruleName: 'No existing account', dataAttribute: 'Liability', operator: '=', amount: 0, outcome: 'Deny', existingAccountOperator: null, existingAccountVariable: 'savings', annualIncomeOperator: '<', annualIncomeVariable: '20000', logicOperator: 'OR' },
    ...
    { id: 'r-10', selected: false, ruleName: 'Debt Ratio Denial', dataAttribute: 'Income', operator: '<', amount: 35000, outcome: 'Deny', existingAccountOperator: null, existingAccountVariable: 'savings', annualIncomeOperator: '<', annualIncomeVariable: '35000' },
    { id: 'r-11', selected: false, ruleName: 'Bankruptcy Flag Denial', dataAttribute: 'Income', operator: '=', amount: 0, outcome: 'Deny', existingAccountOperator: null, existingAccountVariable: 'credit-card', annualIncomeOperator: '<', annualIncomeVariable: '25000' },
    {
      ...
      children: [
        ...
        { id: 'r-12-c2', selected: false, ruleName: 'Account age 12+ months', dataAttribute: 'Income', operator: '>=', amount: 12, outcome: 'Approve', existingAccountOperator: null, existingAccountVariable: 'savings', annualIncomeOperator: '>=', annualIncomeVariable: '60000', logicOperator: 'AND' },
      ],
    },
    ...
    { id: 'r-14', selected: false, ruleName: 'Self-Employed Review', dataAttribute: 'Income', operator: '>=', amount: 90000, outcome: 'Approve', existingAccountOperator: null, existingAccountVariable: 'checking', annualIncomeOperator: '>=', annualIncomeVariable: '90000' },
    { id: 'r-15', selected: false, ruleName: 'Recent Inquiry Limit', dataAttribute: 'Income', operator: '>=', amount: 45000, outcome: 'Deny', existingAccountOperator: null, existingAccountVariable: 'checking', annualIncomeOperator: '>=', annualIncomeVariable: '45000' },
    { id: 'r-16', selected: false, ruleName: 'Collections Flag Denial', dataAttribute: 'Income', operator: '>', amount: 0, outcome: 'Deny', existingAccountOperator: null, existingAccountVariable: 'credit-card', annualIncomeOperator: '<', annualIncomeVariable: '20000' },
  ],
}
