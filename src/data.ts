    ...
    rules: [
      {
        ...
        children: [
          { id: 'r-1-c1', selected: false, ruleName: 'Premium account holder', dataAttribute: 'Asset', operator: '>=', amount: 50000, outcome: 'Approve', existingAccountOperator: 'contains', existingAccountVariable: 'existing-account', annualIncomeOperator: null, annualIncomeVariable: '', logicOperator: 'AND' },
          { id: 'r-1-c2', selected: false, ruleName: 'Credit score 780+', dataAttribute: 'Income', operator: '>=', amount: 780, outcome: 'Approve', existingAccountOperator: null, existingAccountVariable: '', annualIncomeOperator: '==', annualIncomeVariable: 'credit-score', logicOperator: 'AND' },
        ],
      },
