...
export const initialRulesets: Ruleset[] = [
  {
    ...
    rules: [
      { id: 'r-1', selected: false, ruleName: 'High Income Approval', dataAttribute: 'Income', operator: '>=', amount: 75000, outcome: 'Approve', existingAccountOperator: '==', existingAccountVariable: '', annualIncomeOperator: '==', annualIncomeVariable: '' },
      ...
      { id: 'r-3', selected: false, ruleName: 'High Expense Denial', dataAttribute: 'Expense', operator: '>', amount: 50000, outcome: 'Deny', existingAccountOperator: '==', existingAccountVariable: '', annualIncomeOperator: '==', annualIncomeVariable: '' },
