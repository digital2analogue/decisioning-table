  ...
  rules: [
    {
      ...
      creditScoreOperator: '>=', creditScoreVariable: '750',
      children: [
        { id: 'r-1-c1', selected: false, ruleName: 'Premium account holder', dataAttribute: 'Asset', operator: '>=', amount: 50000, outcome: 'Approve', existingAccountOperator: null, existingAccountVariable: 'checking', annualIncomeOperator: '>=', annualIncomeVariable: '75000', creditScoreOperator: '>=', creditScoreVariable: '720', logicOperator: 'AND' },
        { id: 'r-1-c2', selected: false, ruleName: 'Credit score 780+', dataAttribute: 'Income', operator: '>=', amount: 780, outcome: 'Approve', existingAccountOperator: null, existingAccountVariable: 'checking', annualIncomeOperator: '>=', annualIncomeVariable: '85000', creditScoreOperator: '>=', creditScoreVariable: '780', logicOperator: 'AND' },
      ],
    },
    { id: 'r-2', selected: false, ruleName: 'Low Income Denial', dataAttribute: 'Income', operator: '<', amount: 20000, outcome: 'Deny', existingAccountOperator: null, existingAccountVariable: 'checking', annualIncomeOperator: '<', annualIncomeVariable: '30000', creditScoreOperator: '<', creditScoreVariable: '580' },
    {
      ...
      creditScoreOperator: '<', creditScoreVariable: '620',
      children: [
        { id: 'r-3-c1', selected: false, ruleName: 'No existing account', dataAttribute: 'Liability', operator: '=', amount: 0, outcome: 'Deny', existingAccountOperator: null, existingAccountVariable: 'savings', annualIncomeOperator: '<', annualIncomeVariable: '20000', creditScoreOperator: '<', creditScoreVariable: '600', logicOperator: 'OR' },
        { id: 'r-3-c2', selected: false, ruleName: 'Recent inquiries 5+', dataAttribute: 'Liability', operator: '>=', amount: 5, outcome: 'Deny', existingAccountOperator: null, existingAccountVariable: 'credit-card', annualIncomeOperator: '<', annualIncomeVariable: '40000', creditScoreOperator: '<', creditScoreVariable: '640', logicOperator: 'OR' },
      ],
    },
    { id: 'r-4', selected: false, ruleName: 'Moderate Income Approval', dataAttribute: 'Income', operator: '>=', amount: 40000, outcome: 'Approve', existingAccountOperator: null, existingAccountVariable: 'savings', annualIncomeOperator: '>=', annualIncomeVariable: '40000', creditScoreOperator: '>=', creditScoreVariable: '660' },
    { id: 'r-5', selected: false, ruleName: 'Low Expense Approval', dataAttribute: 'Expense', operator: '<=', amount: 15000, outcome: 'Approve', existingAccountOperator: null, existingAccountVariable: 'checking', annualIncomeOperator: '>=', annualIncomeVariable: '35000', creditScoreOperator: '>=', creditScoreVariable: '680' },
    { id: 'r-9', selected: false, ruleName: 'Prime Credit Fast Track', dataAttribute: 'Income', operator: '>=', amount: 80000, outcome: 'Approve', existingAccountOperator: null, existingAccountVariable: 'money-market', annualIncomeOperator: '>=', annualIncomeVariable: '100000', creditScoreOperator: '>=', creditScoreVariable: '800' },
    { id: 'r-10', selected: false, ruleName: 'Debt Ratio Denial', dataAttribute: 'Income', operator: '<', amount: 35000, outcome: 'Deny', existingAccountOperator: null, existingAccountVariable: 'savings', annualIncomeOperator: '<', annualIncomeVariable: '35000', creditScoreOperator: '<', creditScoreVariable: '590' },
    { id: 'r-11', selected: false, ruleName: 'Bankruptcy Flag Denial', dataAttribute: 'Income', operator: '=', amount: 0, outcome: 'Deny', existingAccountOperator: null, existingAccountVariable: 'credit-card', annualIncomeOperator: '<', annualIncomeVariable: '25000', creditScoreOperator: '<', creditScoreVariable: '520' },
    {
      ...
      creditScoreOperator: '>=', creditScoreVariable: '700',
      children: [
        { id: 'r-12-c1', selected: false, ruleName: 'Existing account holder', dataAttribute: 'Asset', operator: '>=', amount: 0, outcome: 'Approve', existingAccountOperator: null, existingAccountVariable: 'checking', annualIncomeOperator: '>=', annualIncomeVariable: '40000', creditScoreOperator: '>=', creditScoreVariable: '680', logicOperator: 'AND' },
        { id: 'r-12-c2', selected: false, ruleName: 'Account age 12+ months', dataAttribute: 'Income', operator: '>=', amount: 12, outcome: 'Approve', existingAccountOperator: null, existingAccountVariable: 'savings', annualIncomeOperator: '>=', annualIncomeVariable: '60000', creditScoreOperator: '>=', creditScoreVariable: '710', logicOperator: 'AND' },
      ],
    },
    { id: 'r-13', selected: false, ruleName: 'High Utilization Denial', dataAttribute: 'Income', operator: '<', amount: 50000, outcome: 'Deny', existingAccountOperator: null, existingAccountVariable: 'credit-card', annualIncomeOperator: '<', annualIncomeVariable: '75000', creditScoreOperator: '<', creditScoreVariable: '630' },
    { id: 'r-14', selected: false, ruleName: 'Self-Employed Review', dataAttribute: 'Income', operator: '>=', amount: 90000, outcome: 'Approve', existingAccountOperator: null, existingAccountVariable: 'checking', annualIncomeOperator: '>=', annualIncomeVariable: '90000', creditScoreOperator: '>=', creditScoreVariable: '720' },
    { id: 'r-15', selected: false, ruleName: 'Recent Inquiry Limit', dataAttribute: 'Income', operator: '>=', amount: 45000, outcome: 'Deny', existingAccountOperator: null, existingAccountVariable: 'checking', annualIncomeOperator: '>=', annualIncomeVariable: '45000', creditScoreOperator: '>=', creditScoreVariable: '650' },
    { id: 'r-16', selected: false, ruleName: 'Collections Flag Denial', dataAttribute: 'Income', operator: '>', amount: 0, outcome: 'Deny', existingAccountOperator: null, existingAccountVariable: 'credit-card', annualIncomeOperator: '<', annualIncomeVariable: '20000', creditScoreOperator: '<', creditScoreVariable: '560' },
  ],
}
...
export const demoRulesets: Ruleset[] = [
  ...
  },
  {
    ...
    rules: [
      ...
      { id: 'r-20', selected: false, ruleName: 'Fraud Flag Denial', dataAttribute: 'Income', operator: '>=', amount: 0, outcome: 'Deny', existingAccountOperator: null, existingAccountVariable: 'checking', annualIncomeOperator: '<', annualIncomeVariable: '500000' },
